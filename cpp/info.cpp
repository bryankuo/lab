...
Info::Info():
    ...
    diff_voltage(0), diff_packnum(0), bms_code(0),
    vehicle_state(0), m_fSlope(0.0f), inclination(0.0f),
    longitude(0.0f),latitude(0.0f),altitude(0.0f),
    gps_mileage(0.0f),
    odo(0.0f),v24(0.0f),dtc(0.0f),
    cell_maxv(0),cell_maxi(0),cell_minv(0),cell_mini(0),
    max_pt_temp(0),max_pt_idx(0),cellVoltages({{0},{0}}),
    ...
    rr_lining(0),ecas33f(0),ecas_kneeling(0),ecas34w(0),
    ...
    evacuation_light(0),rear_defogger_light(0,access_light(0),
    // msg1 b1
    ecas_kneeling(0),rear_fog_light(0),alarm_getoff(0),
    motor_overrun(0),regen_brake(0),parking,motor_op(0),
    // msg1 b2
    abs(0),ecas_warn(0),lining(0),emergency_exit(0),
    // msg1 b3
    motor_alarm(0),air_alarm(0),psteering_alarm(0),mpower_alarm(0),
    // msg1 b4
    v24_alarm(0),lv_alarm(0),charge_abort(0),brake(0),wiper(0),lb_light(0),
    // msg b[6:7]
    reading(0),speed(0),
    m_pGSensor(nullptr),
...
Info::~Info() {
    // TODO: delete pFrameVCU_HMI_MSG01 ... ?
