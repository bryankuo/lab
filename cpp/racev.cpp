...
Racev::~Racev()
{
    ...
    delete m_pFrameParserViobCan06;
#if 0
    // delete handlers
    delete m_pVCU_HMI_MSG02;
    delete m_pBMS_VCU_MSG01;
    delete m_pBMS_VCU_MSG02;
    delete m_pBMS_VCU_MSG03;
    delete m_pBMS_VCU_MSG04;
    delete m_pBMS_CMUERR_MSG01;
    delete m_pVCU_IOSIG_MSG;
    delete m_pVCU_PWR_STATUS;
    delete m_pPCU_IO_SIG00;
    delete m_pPCU_ST_SYS_1;
    delete m_pPCU_ST_SYS_2;
    delete m_pPCU_ST_SYS_3;
    delete m_pPCU_ST_SYS_4;
    delete m_pPCU_ST_MOT_1;
    delete m_pPCU_ST_MOT_2;
    delete m_pPCU_ST_MOT_3;
    delete m_pPCU_CMD_SYS_1;
    delete m_pPCU_CMD_MOT_1;
    delete m_pPCU_CMD_MOT_2;
    delete m_pPCU_CMD_MOT_3;
    delete m_pVCU_DIAG01;
    delete m_pVCU_DIAG02;
    delete m_pBCU_VCU_MSG0;
    delete m_pBCU_VCU_SMD;
    delete m_pBCU_ER_MSG01;
    delete m_pDCDC_MSG00;
    delete m_pTPMS_MSG01;
    delete m_pTPMS_MSG02;
    delete m_pALM_MSG_00;
    delete m_pALM_MSG_01;
    delete m_pALM_MSG_02;
    delete m_pALM_MSG_03;
#endif
    delete m_pAlarmParameters; // TODO: not type of G_OBJECT. is the principle applied?
#if defined ( NEXCOM_CAN06_THREAD_ )
    m_pCANBusPort2->close();
    delete m_pCANBusPort2;
#endif
#if defined ( GPS_THREAD_ )
    delete m_pGPS;
    m_pUART3->close();
...
#if 0
	cout << typeid(*this).name() << "::" << __func__ << ":" << __LINE__ << " "
	    << m_pUART3->readLine().toStdString(); // there's already a linefeed
#endif
	// @see https://tinyurl.com/y59dx7el
	strncpy(sentence, m_pUART3->readLine().toStdString().c_str(), 255);
...
int Racev::getAlarmParameters(QQmlApplicationEngine& engine) {
    ...
    if ( false == ap_file.open(QIODevice::ReadOnly) ) {
        cout << __FILE__ << ":" << __LINE__ << " ap file open!" << endl;
    }
