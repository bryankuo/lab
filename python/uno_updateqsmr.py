...
print("uno_updateqsmr.py+ "+yyyymmdd)
...
doc.Sheets.insertNewByName(NAME037_6,    6)
sheet6 = doc.Sheets.getByName(NAME037_6)

DIR0="./datafiles/taiex/qfbs"
nm0 = NAME037_6 + "." + yyyymmdd + '.txt'
...
new_sheet = doc.Sheets.getByName(NAME037_6)
