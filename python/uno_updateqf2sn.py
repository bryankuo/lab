...
print("uno_updateqf2sn.py+ "+yyyymmdd)
...
doc.Sheets.insertNewByName(NAME037_8,    8)
sheet8 = doc.Sheets.getByName(NAME037_8)

DIR0="./datafiles/taiex/qfbs"
nm0 = NAME037_8 + "." + yyyymmdd + '.txt'
...
new_sheet = doc.Sheets.getByName(NAME037_8)
