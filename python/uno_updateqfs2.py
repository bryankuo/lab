...
print("uno_updateqfs2.py+ "+yyyymmdd)
...
doc.Sheets.insertNewByName(NAME037_7,    7)
sheet7 = doc.Sheets.getByName(NAME037_7)

DIR0="./datafiles/taiex/qfbs"
nm0 = NAME037_7 + "." + yyyymmdd + '.txt'
