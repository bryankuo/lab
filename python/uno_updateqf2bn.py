...
print("uno_updateqf2bn.py+ "+yyyymmdd)
...
doc.Sheets.insertNewByName(NAME037_9,    9)
sheet8 = doc.Sheets.getByName(NAME037_9)

DIR0="./datafiles/taiex/qfbs"
nm0 = NAME037_9 + "." + yyyymmdd + '.txt'
...
new_sheet = doc.Sheets.getByName(NAME037_9)
