...
ticker = sys.argv[1]
hbs30 = "datafiles/taiex/derivatives.txt" # caching html and find
...
try:
    ...
    for i in range(0, len(trs)-1):
        ...
        if ( tkr == ticker ):
            ...
            # print(content)
            # say(ticker, "Mei-Jia")
            ticker_s = ticker[0]+" [[slnc 50]] "+ticker[1]+" [[slnc 50]] "+ticker[2]+" [[slnc 50]] "+ticker[3]
            say(ticker_s, "Mei-Jia")
