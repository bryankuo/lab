...
print("uno_updateqbmd.py+ "+yyyymmdd)
...
doc.Sheets.insertNewByName(NAME037_5,    5)
sheet5 = doc.Sheets.getByName(NAME037_5)

DIR0="./datafiles/taiex/qfbs"
nm0 = NAME037_5 + "." + yyyymmdd + '.txt'
...
new_sheet = doc.Sheets.getByName(NAME037_5)
