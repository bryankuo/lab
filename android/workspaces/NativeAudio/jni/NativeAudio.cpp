...
extern "C" {
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_createEngine(JNIEnv* env, jclass clazz);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_createBufferQueueAudioPlayer(JNIEnv* env, jclass clazz);
JNIEXPORT jboolean Java_com_example_nativeaudio_NativeAudio_createAssetAudioPlayer(JNIEnv* env, jclass clazz, jobject assetManager, jstring filename);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_setPlayingAssetAudioPlayer(
		JNIEnv* env, jclass clazz, jboolean isPlaying);
JNIEXPORT jboolean Java_com_example_nativeaudio_NativeAudio_createUriAudioPlayer(
		JNIEnv* env, jclass clazz, jstring uri);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_setPlayingUriAudioPlayer(
		JNIEnv* env, jclass clazz, jboolean isPlaying);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_setLoopingUriAudioPlayer(
		JNIEnv* env, jclass clazz, jboolean isLooping);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_setChannelMuteUriAudioPlayer(
		JNIEnv* env, jclass clazz, jint chan, jboolean mute);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_setChannelSoloUriAudioPlayer(
		JNIEnv* env, jclass clazz, jint chan, jboolean solo);
JNIEXPORT int Java_com_example_nativeaudio_NativeAudio_getNumChannelsUriAudioPlayer(
		JNIEnv* env, jclass clazz);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_setVolumeUriAudioPlayer(
		JNIEnv* env, jclass clazz, jint millibel);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_setMuteUriAudioPlayer(JNIEnv* env,
		jclass clazz, jboolean mute);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_enableStereoPositionUriAudioPlayer(
		JNIEnv* env, jclass clazz, jboolean enable);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_setStereoPositionUriAudioPlayer(
		JNIEnv* env, jclass clazz, jint permille);
JNIEXPORT jboolean Java_com_example_nativeaudio_NativeAudio_selectClip(JNIEnv* env,
		jclass clazz, jint which, jint count);
JNIEXPORT jboolean Java_com_example_nativeaudio_NativeAudio_enableReverb(JNIEnv* env,
		jclass clazz, jboolean enabled);
JNIEXPORT jboolean Java_com_example_nativeaudio_NativeAudio_createAudioRecorder(
		JNIEnv* env, jclass clazz);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_startRecording(JNIEnv* env,
		jclass clazz);
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_shutdown(JNIEnv* env,
		jclass clazz);
}

// create the engine and output mix objects
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_createEngine(JNIEnv* env,
		jclass clazz) {
	SLresult result;
...
JNIEXPORT void Java_com_example_nativeaudio_NativeAudio_createBufferQueueAudioPlayer(
		JNIEnv* env, jclass clazz) {
	SLresult result;
...
JNIEXPORT jboolean Java_com_example_nativeaudio_NativeAudio_selectClip(JNIEnv* env,
	...
	case 1:     // CLIP_HELLO
		...
		break;
	case 2:     // CLIP_ANDROID
		nextBuffer = (short *) android1;
		nextSize = sizeof(android1);
		break;
...
JNIEXPORT jboolean Java_com_example_nativeaudio_NativeAudio_createAssetAudioPlayer(
