...
#define LEN_SPEED_MA_FILTER 3
    ...
    uint8_t is_charging_in_progress; // ALM00,B4[0]***
    ...
    int otank_temp2;
    int motor_temp;
    uint8_t cellTemperatures[NUM_PACKS][NUM_TPROBE];
    int torq;
    int gear;
    ...
    // msg1 b1
    int rear_fog_light,alarm_getoff;// ecas_kneeling,
