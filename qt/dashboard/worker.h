...
public slots:
    ...
    void onSignalSessionTimeout(int seconds);
    ...
    void onSignalGPS(void);
    void onSyncGpsTimeToHw(void);
#endif
...
#if defined ( GPS_THREAD_ )
    void signalSyncGpsTimeToHw(void);
#endif
...
private:
    ...
    Racev* m_pRacev;
    Info* m_pInfo;
    bool hasAlarmRecord(quint32 can_addr);
};
