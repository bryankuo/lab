...
#define NUM_PACKS  12
#define BYTES_VOLT 2
#define PRECISION_VOLTAGE 2
#define NUM_TPROBE 4
#define NUM_PRB_T 49  // waste 1 byte
#define NUM_SMOKE  8
#define NUM_VCUIO  8
#define NUM_PCUIO  8
#define NUM_BYTE_FRAME 7
...
// Must sync with speedometer in qml
#define SPEED_ULIMIT 140
#define SPEED_LLIMIT 0

#define MIN_MILAGE 0
#define MAX_MILAGE 10000000 // 0.1 km

#define MAX_CHARGE_VOLTAGE (750.0f)
#define MIN_CHARGE_VOLTAGE (0.0f)

#define MAX_CHARGE_CURRENT (40.0f)
#define MIN_CHARGE_CURRENT (0.0f)

#define KEY_OFF 0x01
#define KEY_ACC 0x02
#define KEY_ON  0x03

#define WKEUP_TOKEN 0xAA
#define SLEEP_TOKEN 0x55
