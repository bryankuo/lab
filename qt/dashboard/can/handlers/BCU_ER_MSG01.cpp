...
void Handler_BCU_ER_MSG01::updateMsg(QCanBusFrame* pframe, QObject* pDstVw) {
	...
	// byte 3
	QMetaObject::invokeMethod(pDstVw, "updateMsg_BCU_ER_MSG01",
	...
	if ( pDstVw == p_racev->m_pWinBmsAnalog ) {
	    QMetaObject::invokeMethod(pDstVw, "updateMsg_BCU_ER_MSG01_Byte0",
		Qt::BlockingQueuedConnection,
		Q_RETURN_ARG(QVariant, returnedValue),
	    ...
	    QMetaObject::invokeMethod(pDstVw, "updateMsg_BCU_ER_MSG01_Byte1",
		Qt::BlockingQueuedConnection,
		Q_RETURN_ARG(QVariant, returnedValue),
		Q_ARG(QVariant, ch_shv),
		Q_ARG(QVariant, ds_shv),
	    ...
	    QMetaObject::invokeMethod(pDstVw, "updateMsg_BCU_ER_MSG01_Byte2",
		Qt::BlockingQueuedConnection,
		Q_RETURN_ARG(QVariant, returnedValue),
		Q_ARG(QVariant, oc_ch),
		Q_ARG(QVariant, oc_ds));

	    QMetaObject::invokeMethod(pDstVw, "updateMsg_BCU_ER_MSG01_Byte4",
		Qt::BlockingQueuedConnection,
		Q_RETURN_ARG(QVariant, returnedValue),
	    ...
	    QMetaObject::invokeMethod(pDstVw,"updateMsg_BCU_ER_MSG01_Byte5",
		Qt::BlockingQueuedConnection,
		Q_RETURN_ARG(QVariant, returnedValue),
		Q_ARG(QVariant, c1),
		Q_ARG(QVariant, c2),
	    ...
	    QMetaObject::invokeMethod(pDstVw,"updateMsg_BCU_ER_MSG01_Byte6",
		Qt::BlockingQueuedConnection,
		Q_RETURN_ARG(QVariant, returnedValue),
		Q_ARG(QVariant, c9),
		Q_ARG(QVariant, c10),
